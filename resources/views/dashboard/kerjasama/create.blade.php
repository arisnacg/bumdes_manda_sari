		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
					<div class="col-sm-12 col-md-8">
							...
							<form class="form-horizontal" method="POST" action="{{ route('kerjasama.store') }}" enctype="multipart/form-data">
								@csrf
								<div class="panel panel-default">
										<div class="panel-heading text-muted">Kerja Sama <span class="label label-info m-l-5">Baru</span></div>
