		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
					<div class="col-sm-12 col-md-6">
							...
							<form class="form-horizontal" method="POST" action="{{ route('price_type.store') }}">
								@csrf
								<div class="panel panel-default">
										<div class="panel-heading text-muted">Price Type <span class="label label-info m-l-5">New</span></div>
										<div class="panel-wrapper collapse in">
												<div class="panel-body">
													...
													<div class="form-group row {{ $errors->has('color') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-10">
															<input name="color" type="text" class="colorpicker form-control" value="{{ old('color') }}" />
															@if($errors->has('color'))
												...
												<div class="panel-footer text-right">
														<a href="{{ route('price_type.index') }}" type="submit" class="btn btn-default waves-effect waves-light" type="button"><span class="btn-label"><i class="zmdi zmdi-long-arrow-return"></i></span> Back</a>
