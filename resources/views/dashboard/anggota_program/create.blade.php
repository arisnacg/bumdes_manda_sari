...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<li><a href="{{ route("anggota_program.show", ["id_program" => $program->id]) }}">Anggota</a></li>
			@endcomponent
            <!-- .row -->
			<div class="row justify-content-center">
					<div class="col-sm-12 col-md-10">
                            @include('dashboard.inc.alert')
							<form class="form-horizontal" method="POST" action="{{ route('anggota_program.store') }}" enctype="multipart/form-data">
								@csrf
								<div class="panel panel-default">
										<div class="panel-heading text-muted">{{ $program->nama }} <span class="label label-info m-l-5">Anggota Baru</span></div>
										<div class="panel-wrapper collapse in">
												<div class="panel-body">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('umur') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-3">
															<div class="input-group">
																<input name="umur" type="number" class="form-control" value="{{ old('umur') }}">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('pekerjaan') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-5">
															<input name="pekerjaan" type="text" class="form-control" value="{{ old('pekerjaan') }}">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('alamat') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-10">
															<textarea name="alamat" type="number" rows="2" class="form-control">{{ old('alamat') }}</textarea> 
                                                    ...
                                                    <div class="form-group row {{ $errors->has('informasi') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-10">
															 <textarea id="editor" name="informasi" class="summernote">{!! old("informasi") !!}</textarea>
												...
												<div class="panel-footer text-right">
														<a href="{{ route('anggota_program.show', ['id_program' => $program->id]) }}" type="submit" class="btn btn-default waves-effect waves-light m-r-5" type="button"><span class="btn-label"><i class="zmdi zmdi-long-arrow-return"></i></span> Kembali</a>
