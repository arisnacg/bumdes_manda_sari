                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="text-left m-b-20">
                                    <a target="_blank" href="{{ route("page.program", ['url' => $row->url]) }}" class="btn btn-primary waves-effect waves-light" type="button">
                                ...
                                <div class="img-container">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <img class="img-cropper" id="image" src="{{ '/website/images/program/'.$row->gambar }}">
                                        </div>
                                        <div class="col-md-4">
...
<script src="{{ asset('admin/js/upload_gambar/program.js') }}"></script>
@endsection