		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
					<div class="col-sm-12 col-md-10">
							...
							<form class="form-horizontal" method="POST" action="{{ route('anggota.update', ['id' => $row->id]) }}" enctype="multipart/form-data">
								@csrf
								@method("PUT")
								<div class="panel panel-default">
										<div class="panel-heading text-muted">Anggota <span class="label label-info m-l-5">Edit</span></div>
												...
												<div class="panel-body">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('jabatan') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-5">
															<input name="jabatan" type="text" class="form-control" value="{{ $row->jabatan }}">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('pendidikan') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-5">
															<input name="pendidikan" type="text" class="form-control" value="{{ $row->pendidikan }}">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('no_hp') ? 'has-danger' : '' }}">
														...
														<div class="col-sm-12 col-md-5">
															<input name="no_hp" type="text" class="form-control" value="{{ $row->no_hp }}">
															@if($errors->has('no_hp'))
