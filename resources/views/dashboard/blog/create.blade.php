            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Blog <span class="label label-info m-l-5">Baru</span></div>
                                ...
                                <form method="POST" action="{{ route("blog.store") }}">
                                        ...
                                        <div class="text-right m-b-20">
                                            <button type="submit" class="btn btn-success waves-effect waves-light" type="button">
                                                <span class="btn-label"><i class=" zmdi zmdi-save"></i></span> Simpan Blog
                                            </button>
                                        </div>
                                            ...
                                            <div class="col-sm-12 col-md-5">
                                                <select name="id_kategori" class="form-control">
                                                    @foreach($kategori_blog as $e)
                                                        <option value="{{ $e->id }}"
                                                            @if(old("id_kategori") == $e->id) selected @endif
                                                            >{{ $e->nama }}</option>
                                                    @endforeach
                                                </select>
