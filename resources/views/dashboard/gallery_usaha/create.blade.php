...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <li><a href="{{ route("unit_usaha.index") }}">Unit Usaha</li>
            <li><a href="{{ route("gallery_usaha.gallery", ["id_unit_usaha" => $unit_usaha->id]) }}">Gallery</li>
            @endcomponent
            <!-- .row -->
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ $unit_usaha->nama }}</div>
...
@section('js')
<script>
    var ID_USAHA = {{ $unit_usaha->id }};
</script>
<script src="{{ asset('admin/plugins/bower_components/cropper/cropper.min.js') }}"></script>
<script src="{{ asset('admin/js/custom.js') }}"></script>
<script src="{{ asset('admin/js/upload_gambar/gallery_usaha.js') }}"></script>
@endsection